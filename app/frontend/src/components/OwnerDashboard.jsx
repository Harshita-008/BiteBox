    ...
    <div className='w-full min-h-screen bg-[#fff9f9] flex flex-col items-center'>
          ...
          <div className='flex justify-center items-center p-4 sm:p-6 mt-8'>
            <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
              <div className='flex flex-col items-center text-center'>
                ...
                <h2 className='text-xl sm:text-sxl font-bold text-gray-800 mb-2'>Add Your Restaurant</h2>
                <p className='tex-gray-600 mb-4 text-sm sm:text-base'>Join our food delivery platform and reach thousands of hungry customers everyday.</p>
        ...
        {myShopData && 
          <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
            <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-10 text-center'><FaUtensils className='text-[#ff4d2d] w-12 h-14 mt-2'/>Welcome to {myShopData.name}</h1>
            ...
            {myShopData.items.length==0 &&
              <div className='flex justify-center items-center p-4 sm:p-6 mt-8'>
                <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                  <div className='flex flex-col items-center text-center'>
                    <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4'/>
                    <h2 className='text-xl sm:text-sxl font-bold text-gray-800 mb-2'>Add Your Food Item</h2>
                    <p className='tex-gray-600 mb-4 text-sm sm:text-base'>Share your delicious creations with our customers by adding them to the menu.</p>
