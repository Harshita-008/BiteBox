...
const UserDashboard = () => {
    ...
    const handleFliterByCategory = (category) => {
        if(category=="All") {
    ...
    return (
        <div className='w-screen min-h-screen flex flex-col gap-5 items-center bg-[#fff9f9] overflow-y-auto'>
            ...
            {searchItems && searchItems.length>0 && (
                <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-5 bg-white shadow-md rounded-2xl mt-12'>
            ...
            <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[30px]'>
                ...
                <div className='w-full relative'>
                    ...
                    <div className='w-full flex overflow-x-auto gap-4 pb-2' ref={cateScrollRef}>
                        {categories.map((cate, index) => (
                            <CategoryCard name={cate.category} image={cate.image} key={index} onClick={()=>handleFliterByCategory(cate.category)}/>
                        ))}
                    </div>
